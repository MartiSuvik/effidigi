...
export function Footer() {
	...
	const footerLinks: FooterSection[] = [
		{
			...
			links: [
				{ title: t('footer.services.phoneAgent'), href: '/#services' },
				{ title: t('footer.services.dataAnalytics'), href: '/services/data-ai' },
				{ title: t('footer.services.chatAgent'), href: '/#features' },
				{ title: t('footer.services.crmIntegration'), href: '/#contact' },
			],
		},
		{
			label: t('footer.company'),
			links: [
				{ title: t('footer.companyLinks.blog'), href: '/blog' },
	...
	return (
		<footer className="w-full bg-[#141519]">
			<div className="md:rounded-t-6xl relative w-full max-w-6xl mx-auto flex flex-col items-center justify-center rounded-t-4xl border-t px-6 py-12 lg:py-16">
