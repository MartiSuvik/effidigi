...
export function SiteHeader() {
  ...
  const services = [
    {
      title: "Karl - Data AI",
      description: "Analüüsib kliendiandmeid ja loob detailseid raporteid teie äri optimeerimiseks.",
      href: "/services/data-ai",
      src: "https://res.cloudinary.com/effichat/image/upload/v1751621636/d2fzxkwdvndlenhlezxy.png",
    },
    {
      title: "Sandra - Phone AI",
      description: "24/7 telefonivastamisteenus, mis käsitleb kõiki kõnesid professionaalselt.",
      href: "/#services", 
      src: "https://res.cloudinary.com/effichat/image/upload/v1751621636/ck7yx757bjfj6uihrdyj.png",
    },
    {
      title: "Silver - Chat AI",
      description: "Nutika vestlusrobot, mis vastab küsimustele ja aitab kliente reaalajas.",
      href: "/#services",
      src: "https://res.cloudinary.com/effichat/image/upload/v1751621635/g4v24ilp1cno7r9qyvct.png",
    },
    {
      title: "Helen - CRM AI",
      description: "Haldab kliendisuhteid ja automatiseerib müügiprotsesse tõhusalt.",
      href: "/#services",
  ...
  const mobileNavItems = [
    { label: "Avaleht", href: "/" },
    { label: "Lahendused", href: "/#services" },
              ...
              <div className="flex-1 flex justify-center">
                <div className="flex items-center space-x-8">
                  ...
                  <Menu setActive={setActive} className="flex items-center space-x-8">
                    <MenuItem setActive={setActive} active={active} item="Lahendused">
                    ...
                    <MenuItem setActive={setActive} active={active} item="Blogi">
                      <div className="flex flex-col space-y-2 min-w-[200px]">
                        <HoveredLink href="/blog">Kõik artiklid</HoveredLink>
                        <HoveredLink href="/blog/ai-lahendused-toitlustuses">AI restoranides</HoveredLink>
                        <HoveredLink href="/blog/ai-autoteenused">AI autoteenused</HoveredLink>
                      </div>
                    </MenuItem>
                  </Menu>
                </div>
